...
3. Linguagem CSS<br />
3.1. Elementos estruturais<br />
3.2. Edição em modo inline, interno e externo<br />
3.3. Seletores e herança<br />
3.4. Estilização com classes e id’s<br />
...
**Acessando elemento. Exemplo:**<br /><br />
&nbsp;p{<br />
&nbsp;&nbsp;&nbsp; parametros;<br />
&nbsp;}<br />
